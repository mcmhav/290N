...
parser.add_argument('-r', '--remove', action='store_true', help='remove file script from server after running')
parser.add_argument('--screen', action='store_true', help='remove file script from server after running')
